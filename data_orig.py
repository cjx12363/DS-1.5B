...
def _h5_load(path, key):
    """h5py 加载 .mat 文件（兼容 NumPy 2.0）"""
...
class Dataset_Pro(data.Dataset):
    def __init__(self, file_path_r, file_path_t, is_train=1, ir=1, SNR=15, is_U2D=0, is_few=0,
        ...
        self.SNR = SNR
        self.ir = ir
        H_his = _h5_load(file_path_r, 'H_U_his')  # v,b,l,k,a,b,c
        if is_U2D:
            H_pre = _h5_load(file_path_t, 'H_D_pre')  # v,b,l,k,a,b,c
        else:
            H_pre = _h5_load(file_path_t, 'H_U_pre')  # v,b,l,k,a,b,c
