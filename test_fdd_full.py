...
if __name__ == "__main__":
    ...
    pred_path = "./data/test/" + args.scenario + "_H_D_pre_test.mat"
    model_path = './Weights/LLM4CP_DS_FDD.pth'
    ...
    test_data_pred_base = hdf5storage.loadmat(pred_path)['H_D_pre_test']
    ...
    fout = open(time.strftime("%Y%m%d_%H%M%S") + "_nmse_fdd.csv", "w")
